...
lines.on("line", (line) => {
  ...
  if (message.method === "request/server") {
    process.stdout.write(`${JSON.stringify({ id: "server-91", method: "item/fileChange/requestApproval", params: { reason: "test" } })}\n`);
  }
  if (message.method === "exit/abrupt") {
    process.exit(17);
  }
  if (message.id === "server-91" && message.result?.decision === "decline") {
